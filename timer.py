...
Enter = True
                                           ...
                                           #have an option to go back and pick timer/stopwatch when they need
                                           #can try an if statement that says if "enter" key button pressed 
                                           #we print out the optins and agian.
while Enter:
    if options == 'Timer': # if user types in Timer it runs this code under it
        ...
        if __name__ == "__main__": # makes sure that the code is run directly and not through a modul
